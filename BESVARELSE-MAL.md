...
**Student:** Jama Abdillah Abdirashid

**Studentnummer:** Jaabd6771@Oslomet.no
...
Jeg valgte disse entitetene siden det var de jeg syntes passet definisjon best for entiteter fra casen.
Sykkelstasjon - en stasjon er jo et fysisk sted, og systemet må vite hvor syklene befinner seg.  
Lås - Hver sykkel festets av en lås, og en stasjon har flere låser. Så med å ha en lås entitet så kan vi finne ut nøyaktig hvor hver sykkel er parkert. Samme som å vite hvor hver stajson er.
Sykkel - Hver Sykkel har en unikID, og må spores 
Kunde - Brukene av By-sykkel-systemet
Utleie - Uteleien beskriver selvet leie-hendelsen. Vi trenger en Utleie entitet siden da kan vi knytte sammen kunder sammen med syklene. Brukes også til registrere beløp. 

**Attributter for hver entitet:**

[Skriv ditt svar her - list opp attributtene for hver entitet]

Stasjon - StasjonID, Navn, Sted
Lås - LåsID, StasjonsID
Sykkel - SykkelID, LåsID (Når sykkel er utleid settes lås ID til null)
Kunde - KundeID, mobilnummer, epost, fornavn, etternavn
Utleie, UtleieID, KundeID, SykkelID, UtleveringsTidspunkt, InnleveringsTidspunk, Leiebeløp (Innleveringspunkt er NULL når sykkelen fortsatt er ute)
...
StasjonID - Datatype SERIAL for å auto generere primærnøkkel. Dette vil gjøre at verdien lagres automatisk.  Datatype VARCHAR, som vil gjøre det mulig å skrive f.eks stedsnavn, og adressen til stasjon.

LÅS
LåsID - SERIAL, StasjonsID - INTEGER, fordi det er FK, som peker på stasjonsID i stasjonsID tabellen, og den kollonen er SERIAL.
